    ...
    <div class="container cours">
        ...
        <div class="cours-content">
            ...
            <div class="cours-text">
                <h1>Курс ei</h1>
                <p>
                    Человеку нужен человек и этот человек - он <br> сам. Курс приведет к пониманию себя и <br> своего тела через нейросети.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="base">
            <div class="base-item">
                <div class="base-item_content">
                    ...
                    <p>Что я поем? Когда я поем? Сколько кг наберу или <br> скину? Постоянный подсчет съеденного после еды <br> занимают слишком много нашего жизненного <br>
пространства. Времени жить, наслаждаться, строить <br> планы не остается.</p>
                </div>
            </div>
            <div class="base-item">
        ...
        <h2 class="cours-advertisement">Курс – это путевка в жизнь свободную от <br> постоянной тревоги по поводу и без. </h2>
        <div class="wrapper_cours-btn">
