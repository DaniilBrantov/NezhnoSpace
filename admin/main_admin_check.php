...
//!Открыть доступ всем из списка. До 01.06 включ.
...
// класс, который позволяет добавить пользователя в БД. Ещё чтобы была возможность редактировать каждое поле
// 
// Добавить функцию в класс, которая позволяет удалить строку 
