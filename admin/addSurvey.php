...
<section class='survey'>
    ...
    <div class='survey_opening-text'>
        ...
        <p>Благодарим вас за помощь в нашем исследовании. В этой анкете 30 вопросов, прохождение займет у вас 5-10
            минут. Анкета анонимная. Ваши ответы помогают нам создать сервис психологической поддержки.</p>
        <p>Если вы хотите после прохождения теста получить от нас обратную связь и комментарии, то вы можете оставить
            нам свой ник
