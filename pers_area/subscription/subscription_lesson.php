        ...
        <div class="sub_less_cnt">
            <div class='sub_less__firstParagraph'>
                <div class='sub_less__firstParagraph-wrpImg'>
                    <img class='sub_less__firstParagraph-img' src='<?php echo firstPostImage($id); ?>' style='display: <?php echo (boolval(firstPostImage($id)) ? 'block' : 'none'); ?>'/>
                    <div class='sub_less__firstParagraph-befor' style='display: <?php echo (boolval(firstPostImage($id)) ? 'none' : 'block'); ?>'></div>
                </div>
            ...
            <div class='sub_less__img-collage img-collage' style='display: <?php echo (boolval(LastPostImage($id)) ? 'flex' : 'none'); ?>'>
