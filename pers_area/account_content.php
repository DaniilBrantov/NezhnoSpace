                ...
                <div class="account_wrap-gender-age">
                    <div class="account_gender-select">
                        <div class="account_input-gender-wrapper">
                            <input class="account_input-gender account-input-custom" required="required" type="button" value="Пол" />
                            <svg width="40" height="16" viewBox="0 0 40 16" fill='none' xmlns="http://www.w3.org/2000/svg">
                                <path d="M40 4L24.4472 11.7764C24.1657 11.9172 23.8343 11.9172 23.5528 11.7764L8 4" stroke="#421dd8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    ...
                    <div class="account_age-select">
                        <input type="date" id="account_input-age" class="account-input-custom" name="account_input-age" value="" min="1900-01-01" max="2022-12-31" required="required">
                    </div>
                </div>
                <input id="account_personal-name" class="account-input-custom" type="text" placeholder="Имя" required="required" />
                <input id="account_personal-lastName" class="account-input-custom" type="text" placeholder="Фамилия" required="required" />
                <input id="account_personal-email" class="account-input-custom" type="email" placeholder="Почта" required="required" />
                <input id="account_personal-tel" class="account-input-custom" type="tel" placeholder="Телефон" required="required" />
