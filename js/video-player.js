(() => {
  ...
  setInterval(() => {
    ...
    document.querySelector(".duration-video .current-time-video").textContent =
      getTimeCodeFromNum(videoPlayer.currentTime);
  }, 2);
  ...
  speedBtn.addEventListener("click", function (evt) {
