...
$(function () {
  ...
  $(".about_slider").on(
    ...
    function (event, slick, currentSlide, nextSlide) {
      ...
      let square = document.querySelector(".about_slider-before");
      if (square) {
        square.style.background = colors[nextSlide];
      }
    }
  );
});
...
$(function () {
  ...
  let slidesLength = document.querySelectorAll(
    ".it_bothers_me_item.slick-slide"
  ).length;
