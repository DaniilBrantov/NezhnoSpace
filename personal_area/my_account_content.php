        ...
        <form action="https://nezhno.space/auth-check" method='post' id="choice_img_grid">
            ...
            <div class="unsubscribe_form_btns">
                <div class="unsubscribe_form_btn">
                    <button style="background: #424242; font-weight: normal;" class="btn__ok"
                        id="unsubscribe_cancel">Отмена</button>
                </div>
                <div class="unsubscribe_form_btn">
                ...
                <div class="profile_mobile">
                    <div class="profile_img">
                        <?php if($user_assoc["avatar"]){ 
                            echo '<img src="'.img('change_img').''.$user_assoc["avatar"].'.png" alt="">';
                        } else{ 
                            echo '<img src="'.img('account_icon.jpg').'" alt="">';
                        }; ?>
                    </div>
                ...
                <div class="sub_elements">
                    <div class="sub_item announcement_item">
                        <div class="announcement_item_left">
                            <h3>Анонс</h3>
                            <p>Стоп урок, необходимо ознакомиться с инструкцией, чтобы получить доступ к материалам
                                подписки.</p>
                        </div>
            ...
            <div class="account_link">
                ...
                <div class="account_btn">
                    <a href="uchebnaya-programma">
                        <button>
                            <p> Твоя программа </p>
                            <img src="<?php img('account_btn_arrow.svg') ?>" alt="">
                        </button>
                    </a>
                </div>
            </div>
        ...
        <div class="statistics">
            ...
            <div class="statistics_part">
                <div class="statistics_part_img">
                    <img src="<?php img('account_book.svg') ?>" alt="">
                </div>
            ...
            <div class="statistics_part">
                <div class="statistics_part_img">
                    <img src="<?php img('account_pencil.svg') ?>" alt="">
                </div>
                <div class="statistics_part_content">
                    <div class="statistics_part_text">
                        <div class="statistics_part_title">
            ...
            <div class="statistics_part">
                <div class="statistics_part_img">
                    <img src="<?php img('account_ei.svg') ?>" alt="">
                </div>
                <div class="statistics_part_content">
                    <div class="statistics_part_text">
                        <div class="statistics_part_title">
