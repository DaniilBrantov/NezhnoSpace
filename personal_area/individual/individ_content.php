        ...
        <div class="les_audio">
            ...
            <div class="audio_cont">
                <audio id="audio" controls preload="none">
                    <source src="<?php echo get_template_directory_uri(); ?>/personal_area/audio/<?php echo $individual_content['audio']; ?>" type="audio/mpeg">
                    <source src="<?php echo get_template_directory_uri(); ?>/personal_area/audio/<?php echo $individual_content['audio']; ?>" type="audio/ogg">
    ...
    <div class="page__group">  
        ...
        <div class="general_btn">
            <button id="individ_rating_btn">
                <img src="https://nezhno.space/wp-content/themes/my-theme/images/account_arrow.svg" alt="">
            </button>
        </div>
    </div>
