...
<div class="les">
    <div class="les_banner">
        ...
        <hr>
        <iframe class="les_banner_img" width="700" height="400" src="<?php echo $main_stages['video']; ?>"
        ...
        <div class="audio_cont">
            <audio id="audio" controls preload="none">
                <source
                    src="<?php echo get_template_directory_uri(); ?>/personal_area/audio/<?php echo $main_stages['audio']; ?>"
                    type="audio/mpeg">
                <source
                    src="<?php echo get_template_directory_uri(); ?>/personal_area/audio/<?php echo $main_stages['audio']; ?>"
                    type="audio/ogg">
    ...
    <div class="les_audio">
        ...
        <div class="audio_cont">
            <audio id="audio" controls preload="none">
                <source
                    src="<?php echo get_template_directory_uri(); ?>/personal_area/audio/<?php echo $main_stages['second_audio']; ?>"
                    type="audio/mpeg">
                <source
                    src="<?php echo get_template_directory_uri(); ?>/personal_area/audio/<?php echo $main_stages['second_audio']; ?>"
                    type="audio/ogg">
    ...
    <div class="container">
        <div class="less_pdf audio_meditation_cnt">
            <a href="<?php echo get_template_directory_uri(); ?>/personal_area/pdf_files/stage_<?php echo $less_num;?>.pdf"
                download>
                <img src="<?php img('download_icon.png') ?>" alt="">
            </a>
