            ...
            <div class="choice_img_grid">
                <div class="choice_img_item">
                    ...
                    <label for="ImgCheckbox-1">
                        <img id="choiceImg" class="choice_img_avatar" src="<?php img('change_img5.png') ?>" alt="" />
                    </label>
                </div>
                <div class="choice_img_item">
                    <input class="check_img" name="check_img" value="6" type="radio" id="ImgCheckbox-2" />
                    <label for="ImgCheckbox-2">
                        <img id="choiceImg" class="choice_img_avatar" src="<?php img('change_img6.png') ?>" alt="" />
                    </label>
                </div>
                <div class="choice_img_item">
                    <input class="check_img" name="check_img" value="7" type="radio" id="ImgCheckbox-3" />
                    <label for="ImgCheckbox-3">
                        <img id="choiceImg" class="choice_img_avatar" src="<?php img('change_img7.png') ?>" alt="" />
                    </label>
                </div>
                <div class="choice_img_item">
                    <input class="check_img" name="check_img" value="8" type="radio" id="ImgCheckbox-4" />
                    <label for="ImgCheckbox-4">
                        <img id="choiceImg" class="choice_img_avatar" src="<?php img('change_img8.png') ?>" alt="" />
                    </label>
                </div>
            </div>
            ...
            <div class="choice_img_grid">
                <div class="choice_img_item">
                    ...
                    <label for="ImgCheckbox-5">
                        <img id="choiceImg" class="choice_img_avatar"
                            src="<?php echo get_template_directory_uri(); ?>/images/change_img2.png" alt="" />
                    </label>
                </div>
                <div class="choice_img_item">
                    ...
                    <label for="ImgCheckbox-6">
                        <img id="choiceImg" class="choice_img_avatar"
                            src="<?php echo get_template_directory_uri(); ?>/images/change_img1.png" alt="" />
                    </label>
                </div>
                <div class="choice_img_item">
                    ...
                    <label for="ImgCheckbox-7">
                        <img id="choiceImg" class="choice_img_avatar"
                            src="<?php echo get_template_directory_uri(); ?>/images/change_img3.png" alt="" />
                    </label>
                </div>
                <div class="choice_img_item">
                    ...
                    <label for="ImgCheckbox-8">
                        <img id="choiceImg" class="choice_img_avatar"
                            src="<?php echo get_template_directory_uri(); ?>/images/change_img4.png" alt="" />
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="change">
            <div class="change_info">
                <div class="change_img"
                    style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/change_img<?php echo $change_assoc["avatar"]; ?>.png')">
