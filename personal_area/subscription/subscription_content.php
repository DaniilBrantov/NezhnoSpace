...
<div class="wrapper_subscription">
    <div class="container">
        <div class="subscription">
            <div class="subcription_cnt">
                <h1>Подписка</h1>
                <p>Нежно - онлайн платформа психологической поддержки и заботы о себе. Мы часто не принимаем себя и свое
                    тело. Заедаем проблемы и эмоции. Испытываем стресс, тревожимся. Не понимаем: что делать дальше? </p>
                <p>Наша платформа поможет тебе принимать свое тело и справляться с эмоциями. Мы поддержим и направим
                    тебя на путь к здоровым отношениям с едой, своим телом и окружающими. </p>
                ...
                <a href="#pay_subscription_cards" class="wht_btn_with_arr" type="submit">
                    <p>Попробовать</p><img src="<?php echo get_template_directory_uri(); ?>/images/btn_arrow_black.svg"
                        alt="">
                </a>
            </div>
        ...
        <div class="subscription_elements">
            ...
            <div class="subscription_item">
                ...
                <div class="subscription_item_txt">
                    <p>
                        подстраивается под тебя и обучается на твоих подсказках. Для того, чтобы рекомендательная
                        система обучалась, достаточно просто использовать платформу Нежно
                    </p>
                </div>
                <!-- <p class="subscription_item_num">
                    3
    ...
    <div class="pay_subscription">
        ...
        <div id="pay_subscription_cards" class="pay_subscription_cards">
            <form action="<?php echo $href; ?>" method='post'>
                <input id="order" type="hidden" value="<?php echo $order; ?>" name="order">
                ...
                <button class="pay_subscription_card" type="submit">
                    <div style="background: rgba(255, 255, 255, 0.4);" class="pay_subscription_card_img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pay_subscription_card_1.png"
                            alt="">
                    </div>
            ...
            <form action="<?php echo $href; ?>" method='post'>
                ...
                <button class="pay_subscription_card" type="submit">
                    <div style="background: rgba(27, 27, 27, 0.8);" class="pay_subscription_card_img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pay_subscription_card_2.png"
                            alt="">
                    </div>
                    <div class="pay_subscription_card_cnt">
                        <h4>
            ...
            <form action="<?php echo $href; ?>" method='post'>
                ...
                <button style="box-shadow: 0 0 15px 7px rgb(77, 77, 77);" class="pay_subscription_card" type="submit">
                    <div style="background: #101010;" class="pay_subscription_card_img">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pay_subscription_card_3.png"
                            alt="">
                    </div>
                    <div class="pay_subscription_card_cnt">
                        <h4>
